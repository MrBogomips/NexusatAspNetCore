...
namespace Nexusat.AspNetCore.Configuration
{
    ...
    public class NexusatAspNetCoreOptions
    {
        ...
        public string PaginationPageIndexName { get; internal set; } = "pageIndex";
        ...
        public string PaginationPageSizeName { get; internal set; } = "pageSize";
        ...
        public int PaginationDefaultPageSize { get; internal set; } = 10;

        /// <summary>
        /// Gets or sets the size of the pagination default max page.
        /// </summary>
        /// <value>The size of the pagination default max page.</value>
        public int PaginationDefaultMaxPageSize { get; internal set; } = 100;
        ...
        public bool PaginationDefaultBadRequestOnPageSizeOverflow { get; internal set; } = false;
